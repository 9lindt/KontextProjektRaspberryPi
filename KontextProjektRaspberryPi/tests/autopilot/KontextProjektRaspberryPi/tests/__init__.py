...
import KontextProjektRaspberryPi
...
class BaseTestCase(AutopilotTestCase):
    ...
    click_package = '{0}.{1}'.format('KontextProjektRaspberryPi', '9lindt')

    def setUp(self):
        super(BaseTestCase, self).setUp()
        self.launcher, self.test_type = self.get_launcher_and_type()
        self.app = KontextProjektRaspberryPi.TouchApp(self.launcher(), self.test_type)
