...
SUBDIRS += KontextProjektRaspberryPi \
           backend/KontextProjektRaspberryPi
...
UBUNTU_TRANSLATION_DOMAIN="kontextprojektraspberrypi.9lindt"
...
aptest.commands = QML2_IMPORT_PATH=$$OUT_PWD/backend bash $$PWD/KontextProjektRaspberryPi/tests/autopilot/run
aptest.depends  = sub-KontextProjektRaspberryPi sub-backend-App

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/backend/tests/unit -import $$OUT_PWD/backend
unittest.commands += && /usr/bin/qmltestrunner -input $$PWD/KontextProjektRaspberryPi/tests/unit -import $$OUT_PWD/backend
unittest.depends  = sub-KontextProjektRaspberryPi sub-backend-App
